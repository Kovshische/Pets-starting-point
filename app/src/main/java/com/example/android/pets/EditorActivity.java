    ...
    private void insertPet() {
       ...
       // SQLiteDatabase db = mDbHelper.getWritableDatabase();
        ...
        if (newUri == null){
            ...
            displayToast("Error with saving pet");
            Log.i (LOG_TAG,"Error with saving pet");
        } else {
            addPetMessage = "Pet saved successful";
            displayToast(addPetMessage);
